...
Working codebase. 93 Python unit tests (`python3 -m unittest discover tests`). Eight UI tabs wired up (Overview, Trends, Prompts, Sessions, Projects, Skills, Tips, Settings). Runs on macOS, Windows, and Linux.
