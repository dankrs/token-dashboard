...
Working codebase. 100 Python unit tests (`python3 -m unittest discover tests`). Nine UI tabs wired up (Overview, Live, Trends, Prompts, Sessions, Projects, Skills, Tips, Settings). Runs on macOS, Windows, and Linux.
